<?php
    ...
    if ($afectado == 1) {
        echo "<script> alert('El cliente $nombre se editó correctamente :) '); location.href='../../clientes1.php' </script>";
        } else {
        echo "<script> alert('El cliente $nombre no se editó :( '); location.href='../../clientes1.php' </script>";
        }
