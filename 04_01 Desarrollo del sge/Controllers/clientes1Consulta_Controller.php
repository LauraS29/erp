...
// Llamada al modelo
require_once "Models/clientes2Consulta_Model.php";
...
foreach ($data as $row) {
    $rowsHTML .= "<tr>
                    ...
                    <td class='pequeño'><a href='clientes2.php?Cod_cliente=<?php echo $row->Cod_cliente; ?>'><img src='Assets/img/actualizar.png' alt=''></a>
