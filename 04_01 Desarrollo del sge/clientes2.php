            ...
            <form class="flex fondo_form" action="clientes2.php?codigo=" method="post">
                <div class="primer_div">
                    <div class="flex">
                        <div class="pr1">
                            <p>Nombre:</p>
                            <input type="text" id="textoInsercion1" name="Nom_cliente">
                        </div>
                        <div class="pr">
                            <p>Apellidos:</p>
                            <input type="text" id="textoInsercion2" name="Ap_cliente">
                    </div>
                    <div class="flex">
                        <div class="pr">
                            <p>Email:</p>
                ...
                <div class="segundo_div imagen-botones">
                    ...
                    <div class="buttons">
                        <div>
                            <input type="submit" name="botonInsercion1" id="boton1" value="Guardar">
                        </div>
                        <div>
